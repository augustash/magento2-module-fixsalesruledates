...
namespace Augustash\FixSalesRuleDates\Controller\Adminhtml\Promo\Quote;
    ...
    public function execute()
    {
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                /**
                 * AAI HACK: apply fix from magento/magento2 commit #e200425c
                 * to fix the issue of start/end date force autopopulates when
                 * the cart rule is saved.
                 */
